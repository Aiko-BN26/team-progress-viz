...
import io.github.aikobn26.teamprogressviz.service.organization.RepositorySyncStatusService;
...
public class RepositoryActivitySyncService {
    ...
    private void persistCommit(Repository repository, GitHubCommit commit) {
        ...
        io.github.aikobn26.teamprogressviz.entity.GitCommit entity = gitCommitRepository
                .findByRepositoryIdAndShaAndDeletedAtIsNull(repository.getId(), commit.sha())
                .orElseGet(() -> io.github.aikobn26.teamprogressviz.entity.GitCommit.builder()
                        .repository(repository)
                        .sha(commit.sha())
                        .build());
